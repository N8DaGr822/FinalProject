...
namespace FinalProject.UI.MVC.Controllers
{
    public class TSTTicketStatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Description")] TSTTicketStatus tSTTicketStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Description")] TSTTicketStatus tSTTicketStatus)
        {
            if (ModelState.IsValid)
            {
