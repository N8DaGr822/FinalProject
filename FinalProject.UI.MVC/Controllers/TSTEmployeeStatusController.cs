...
namespace FinalProject.UI.MVC.Controllers
{
    public class TSTEmployeeStatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Description")] TSTEmployeeStatus tSTEmployeeStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Description")] TSTEmployeeStatus tSTEmployeeStatus)
        {
            if (ModelState.IsValid)
            {
